---
name: "specify"
description: "Specifies a CDD corpus to extraction-readiness — audits, fixes, and validates until every CDD is mechanically translatable into NIBs."
metadata:
  okf_version: "1.0"
  kind: "AgentSkill"
  domain: "architecture"
  entry_points:
    - "User asks to specify, audit, verify, or review a CDD or architecture specification"
...
├── specs/
│   └── new-specify.md             ← Protocol specification (draft)
├── assets/
...
| Know the full audit protocol spec (draft)           | `specs/new-specify.md`                     |
