...
outputs:
  - path: "$RUNDIR/operational-report.md"
    format: "markdown-operational-report"
dependencies:
  - "~/.agents/conventions/cubits-design-doc.md"
unlock_condition: "Step 09 is CLEAN (all contracts match, vocabulary consistent)"
---

# Step 10: Operational Completeness

Lis `$RUNDIR/coherence-report.md` pour connaître l'état du step 09.
...
This step only executes if **Step 09 (Coherence) is CLEAN**. If Step 09 is blocked, do not execute. Report: *"Operational audit blocked: Step 09 (Coherence) is not clean."*
...
- CLEAN: all relevant constraints defined → proceed to Step 11.
