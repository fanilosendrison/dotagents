#!/usr/bin/env node
/**
 * Bootstrap a new Antigravity wrapper document from one JSON value on stdin.
 * The pure text transformations live in lib.mjs.
 */
...
async function main() {
	...
	const harnessDirectory = join(homedir(), ".gravity");
