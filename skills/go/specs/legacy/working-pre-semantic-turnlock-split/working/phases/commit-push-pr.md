...
pour la phase `pr-ci-review`. Cette phase reste conforme à [`phase-harness/NIB-S-go-phase-harness.md`](../../briefs/phase-harness/NIB-S-go-phase-harness.md) :
...
[`phase-harness/NIB-S-go-phase-harness.md`](../../briefs/phase-harness/NIB-S-go-phase-harness.md). Dans le pipeline complet, elle est enveloppée par une FSM
...
- [`go-pipeline-contract.md`](../pipeline/go-pipeline-contract.md) — contrat des phases, sévérités, artefacts JSON, et gates
