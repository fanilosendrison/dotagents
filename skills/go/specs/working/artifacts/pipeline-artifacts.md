...
`PhaseOutput` définie dans [`phase-harness/`](../../briefs/phase-harness/). Les champs
...
Enregistré par `workspace-setup`. Voir [`workspace-setup.md`](../phases/workspace-setup.md).
...
Produit par `pre-pr-review` et `pr-ci-review`. Voir [`ideal-review.md`](../review/ideal-review.md)
