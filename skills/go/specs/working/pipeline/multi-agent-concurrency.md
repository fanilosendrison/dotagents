...
[`phase-harness/NIB-S-go-phase-harness.md`](../../briefs/phase-harness/NIB-S-go-phase-harness.md), puis sont enveloppées par cette orchestration. Les sessions
...
- [`commit-push-pr.md`](../phases/commit-push-pr.md) — découpage Git, branches, stacked PRs
- `ideal-review.md` — les 13 dimensions de la review
- [`agent-conduct-check.md`](../phases/agent-conduct-check.md) — règles de conduite de l'agent
