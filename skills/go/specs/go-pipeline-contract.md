...
4. **Pas de jugement caché dans le pipeline** : une branche conditionnelle de
   la FSM dépend d'un booléen, d'un exit code, d'un hash, d'un compteur, ou d'un
   finding structuré. Elle ne dépend jamais d'une phrase libre.
...
Zod, JSON Schema, ou types TypeScript, mais les champs obligatoires doivent
rester stables.
