...
referenced_by:
  ...
  - NIB-M-GO-STAGE-HARNESS-INVOCATION
  - NIB-M-GO-STAGE-HARNESS-STATE
...
Filesystem and runtime errors must be mapped according to stage-harness stage:
...
- State collection read errors produce blocking `StageError`s and set only the
