...
- [!] Rerun after `32941058800` confirmed both host-dependent test fixes and exposed only the stale validation-chain expectation, now updated for isolated git-commits-push execution.
