...
export const FACADE_ENTRIES: readonly FacadeEntry[] = [
  // ── Skills ──────────────────────────────────────────────
  { source: "skills/loop-clean", destination: "skills/loop-clean", kind: "directory" },
  { source: "skills/coding-standards", destination: "skills/coding-standards", kind: "directory" },
  ...
  { source: "agents/fix-file.md", destination: "agents/fix-file.md", kind: "file" },
  { source: "agents/senior-review-file.md", destination: "agents/senior-review-file.md", kind: "file" },

  // ── Scripts ─────────────────────────────────────────────
  { source: "scripts/coding-standards-scanner", destination: "scripts/coding-standards-scanner", kind: "directory" },
  { source: "scripts/coding-standards-consolidate", destination: "scripts/coding-standards-consolidate", kind: "directory" },
  { source: "scripts/lib/coding-standards-schema", destination: "scripts/lib/coding-standards-schema", kind: "directory" },
  { source: "scripts/lib/stack-tools", destination: "scripts/lib/stack-tools", kind: "directory" },
];
