...
// ── Functions used by the pre-commit hook ──────────────────────────────

/**
 * Detect whether the raw shell command is / contains a git commit.
 */
 ...
 *   git commit -m "..."
 *   git commit -m '...'
 *   git commit -m <<'EOF' ... EOF
 *
 * Returns the message subject (first non-empty line) or null if not found.
 */
 ...
 *   type(scope)!: description
 *
 * Where type is any lowercase word.
 */
...
/**
 * Check if the raw command includes a git push instruction.
 */
